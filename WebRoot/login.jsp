			...
			if(xmlHttpRequest.readyState == 4){
				...
				if(xmlHttpRequest.status == 200){
					...
					if(result == "true"){
						...
						errMsg.innerHTML="账号密码正确:Ajax验证";
					} else{

						var errMsg = document.getElementById("errMsg");
						errMsg.style.color="red";
						errMsg.style.display="block";
						errMsg.innerHTML="账号或密码错误:Ajax验证";
					}
				...
				<div id="main-loginBox">
					...
					<form class="main-loginBox-center" id="myform" action="servlet/loginServlet" method="get">
						...
						<div class="tusername">
							...
							<td><span id="userMsg" style="color:red">${errMsg.userMsg }</span></td>
							<br>
							</tr>
						</div>
						...
						<div class="tpassword">
							...
							<td><span id="pwdMsg" style="color:red">${errMsg.pwdMsg }</span></td>
							</tr>
						</div>
