...
<form method="POST" action="servlet/SecondAccountServlet" class="form-style">
...
<input type="hidden" id="tel_charge" name="tel_charge" value="<%=request.getParameter("tel_charge") %>">
<input type="hidden" id="T4" name="T4" value="<%=request.getParameter("T4") %>">
